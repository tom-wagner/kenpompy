...
# NOTES 3/5/25
1. Run code with `python3 scripts/main.py --date 03-05-2025`
2. Not sure on configuration for rate limiter

TODO: Determine path forward on automizing

# Pipeline Note
The staged pipeline operator guide now lives in the repo-root [README.md](/Users/tomwagner/kenpompy/README.md).

Use the stage scripts there instead of treating `scripts/full_pipeline.py` as the primary interface.

The Unabated response used by this project comes from:

```text
https://content.unabated.com/markets/v2/league/4/propodds.json
```
